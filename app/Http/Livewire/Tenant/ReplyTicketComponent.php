...
class ReplyTicketComponent extends Component
{
    ...
    {
        return [
            'attachments.*.mimes' => __('Attachments must be a file of type: pdf, jpg, jpeg, png.'),
            'attachments.*.max' => __('Attachment may not be greater than 10MB.'),
        ];
    }
    ...
    {
        return view('livewire.tenant.reply-ticket-component');
    }
    ...
    public function submit()
    {
        ...
        return redirect()->route('tenant.support-tickets.show', $this->ticketId);
    }
}
