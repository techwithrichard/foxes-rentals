  ...
  NioApp.CurrentLink = function () {
    ...
    $(_link).each(function () {
      var self = $(this),
        ...
        //   self.closest("li").addClass('current-page').parents().closest("li").addClass(" current-page");
        //   self.closest("li").children('.nk-menu-sub').css('display', 'block');
        //   self.parents().closest("li").children('.nk-menu-sub').css('display', 'block');
        // } else {
        //   self.closest("li").removeClass(' current-page').parents().closest("li:not(.current-page)").removeClass("active");
        // }
