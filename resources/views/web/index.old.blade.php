                    ...
                    <div class="header-caption">
                        <div class="header-badge">
                            <div class="badge-pro">
                                ...
                                <span class="badge-pro-text">Foxes Rental System</span>
                            </div>
                        </div>
            ...
            <div class="row justify-content-center text-center">
                <div class="col-lg-9 col-md-10">
                    <div class="text-block is-compact py-3">
                        <h2 class="title">{{ __('All Properties. All Unit Counts.')}} </h2>
                        <p>{{ __('Whether you manage five doors or five thousand, you need a simple, unified platform that
                            powers you to be your best.Choose Foxes Rental Systems today so you can scale your
                            tomorrow.')}}
                        </p>
                        <ul class="btns-inline justify-center pt-2">
                            <li><a href="#" class="btn btn-xl btn-primary btn-round">{{ __('Contact Foxes Foxes Rental Systems,  Today!')}}</a></li>
                        </ul>
                    </div>
                </div>
            </div>
                                ...
                                <div class="card-inner card-inner-xl">
                                    <div class="text-block">
                                        ...
                                        <ul class="list list-nostyle fs-16px">
                                            <li>Windsor  House</li>
                                            <li>Third Floor, Room 3</li>
                                            <li>P.O. Box 123</li>
                                            <li>Nairobi</li>
                                            <li class="note "> www.foxes.co.ke</li>
                                            <li class="note text-warning">Your property counts!</li>
                                        </ul>
                                        <ul class="btns-inline">
                                            <li><a href="" target="_blank" class="btn btn-xl btn-primary">Contacts Us Today</a></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
