...
<html lang="zxx">
<head>
    <title>FOXES - Real Estates</title>
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta charset="UTF-8">
    <!-- External CSS libraries -->
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/bootstrap.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/magnific-popup.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/jquery.selectBox.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/dropzone.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/rangeslider.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/animate.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/leaflet.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/slick.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/slick-theme.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/map.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/jquery.mCustomScrollbar.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/fonts/font-awesome/css/font-awesome.min.css')}}">
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/fonts/flaticon/font/flaticon.css')}}">

    <!-- Favicon icon -->
    <link rel="shortcut icon" href="{{url('frontend/asset/img/favicon.ico')}}" type="image/x-icon" >

    <!-- Google fonts -->
    <link rel="stylesheet" type="text/css" href="https://fonts.googleapis.com/css?family=Open+Sans:400,300,600,700,800%7CPlayfair+Display:400,700%7CRoboto:100,300,400,400i,500,700">

    <!-- Custom Stylesheet -->
    <link type="text/css" rel="stylesheet" href="{{url('frontend/asset/css/style.css')}}">
    <link rel="stylesheet" type="text/css" id="style_sheet" href="{{url('frontend/asset/css/skins/default.css')}}">
                    ...
                    <div id="propertiesDetailsSlider" class="carousel properties-details-sliders slide">
                        ...
                        <div class="carousel-inner">
                            <div class="active item carousel-item" data-slide-number="0">
                                <img src="./assets/img/property/img-5.png" class="img-fluid" alt="property-box-6">
                            </div>
                            <div class="item carousel-item" data-slide-number="1">
                                <img src="./assets/img/property/img-4.png" class="img-fluid" alt="property-box-6">
                            </div>
                            <div class="item carousel-item" data-slide-number="2">
                                <img src="./assets/img/property/img-3.png" class="img-fluid" alt="property-box-6">
                            </div>
                            <div class="item carousel-item" data-slide-number="4">
                                <img src="./assets/img/property/img-2.png" class="img-fluid" alt="property-box-6">
                            </div>
                            <div class="item carousel-item" data-slide-number="5">
                                <img src="./assets/img/property/img-1.png" class="img-fluid" alt="property-box-6">
                            </div>
        ...
        <div class="slick-slider-area">
            <div class="row slick-carousel wow fadeInUp delay-04s" data-slick='{"slidesToShow": 3, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="agent-3">
                        <div class="photo">
                            <img src="./assets/img/avatar/avatar-5.png" alt="agent-3" class="img-fluid">
                ...
                <div class="slick-slide-item">
                    <div class="agent-3">
                        <div class="photo">
                            <img src="./assets/img/avatar/avatar-7.png" alt="agent-3" class="img-fluid">
                            <div class="agent-overlay">
                                <div class="job">
                ...
                <div class="slick-slide-item">
                    <div class="agent-3">
                        <div class="photo">
                            <img src="./assets/img/avatar/avatar-6.png" alt="agent-3" class="img-fluid">
                            <div class="agent-overlay">
                                <div class="job">
                                    <h6>Web Developer</h6>
                                </div>
                ...
                <div class="slick-slide-item">
                    <div class="agent-3">
                        <div class="photo">
                            <img src="./assets/img/avatar/avatar-8.png" alt="agent-3" class="img-fluid">
                            <div class="agent-overlay">
                                <div class="job">
                ...
                <div class="testimonial-inner">
                    ...
                    <div id="carouselExampleIndicators2" class="carousel slide" data-ride="carousel">
                        ...
                        <div class="carousel-inner">
                            <div class="carousel-item active">
                                <div class="avatar">
                                    <img src="./assets/img/avatar/avatar-2.png" alt="avatar" class="img-fluid">
                                </div>
                                <p>
                            ...
                            <div class="carousel-item">
                                <div class="avatar">
                                    <img src="./assets/img/avatar/avatar-3.png" alt="avatar" class="img-fluid">
                                </div>
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                                </p>
                            ...
                            <div class="carousel-item">
                                <div class="avatar">
                                    <img src="./assets/img/avatar/avatar.png" alt="avatar" class="img-fluid">
                                </div>
                                <p>
                                    Lorem Ipsum is simply dummy text of the printing and typesetting industry. Lorem Ipsum has been the industry's standard dummy text ever since the 1500s, when an unknown printer took a galley of type
                                </p>
        ...
        <div class="slick-slider-area">
            <div class="row slick-carousel wow fadeInUp delay-04s" data-slick='{"slidesToShow": 3, "responsive":[{"breakpoint": 1024,"settings":{"slidesToShow": 2}}, {"breakpoint": 768,"settings":{"slidesToShow": 1}}]}'>
                <div class="slick-slide-item">
                    <div class="blog-5">
                        <div class="blog-image">
                            <img src="./assets/img/blog/blog-2.png" alt="blog" class="img-fluid">
                ...
                <div class="slick-slide-item">
                    <div class="blog-5">
                        <div class="blog-image">
                            <img src="./assets/img/blog/blog.png" alt="blog" class="img-fluid">
                            <div class="post-meta clearfix">
                                <span><a href="#"><i class="fa fa-user"></i></a>Admin</span>
                                <span><a href="#"><i class="fa fa-commenting-o"></i></a>17K</span>
                                <span><a href="#"><i class="fa fa-heart-o"></i></a>73k</span>
                ...
                <div class="slick-slide-item">
                    <div class="blog-5">
                        <div class="blog-image">
                            <img src="./assets/img/blog/blog-3.png" alt="blog" class="img-fluid">
                            <div class="post-meta clearfix">
                                <span><a href="#"><i class="fa fa-user"></i></a>Admin</span>
                                <span><a href="#"><i class="fa fa-commenting-o"></i></a>17K</span>
                                <span><a href="#"><i class="fa fa-heart-o"></i></a>73k</span>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="logo-image">
                    <a href="#"><img src="./assets/img/logos/black-logo.png" alt="logo"></a>
                </div>
...
<script src="{{url('frontend/asset/js/jquery-2.2.0.min.js')}}"></script>
<script src="{{url('frontend/asset/js/popper.min.js')}}"></script>
<script src="{{url('frontend/asset/js/bootstrap.min.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.selectBox.js')}}"></script>
<script src="{{url('frontend/asset/js/rangeslider.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.magnific-popup.min.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.filterizr.js')}}"></script>
<script src="{{url('frontend/asset/js/wow.min.js')}}"></script>
<script src="{{url('frontend/asset/js/backstretch.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.countdown.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.scrollUp.js')}}"></script>
<script src="{{url('frontend/asset/js/particles.min.js')}}"></script>
<script src="{{url('frontend/asset/js/typed.min.js')}}"></script>
<script src="{{url('frontend/asset/js/dropzone.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.mb.YTPlayer.js')}}"></script>
<script src="{{url('frontend/asset/js/leaflet.js')}}"></script>
<script src="{{url('frontend/asset/js/leaflet-providers.js')}}"></script>
<script src="{{url('frontend/asset/js/leaflet.markercluster.js')}}"></script>
<script src="{{url('frontend/asset/js/slick.min.js')}}"></script>
<script src="{{url('frontend/asset/js/maps.js')}}"></script>
<script src="{{url('frontend/asset/js/jquery.mCustomScrollbar.concat.min.js')}}"></script>
<script src="https://maps.googleapis.com/maps/api/js?key=AIzaSyD4omYJlOaP814WDcCG8eubXcbhB-44Uac"></script>
<script src="{{url('frontend/asset/js/ie-emulation-modes-warning.js')}}"></script>
<!-- Custom JS Script -->
<script  src="{{url('frontend/asset/js/app.js')}}"></script>
</body>
</html>