    ...
    <div class="card-inner-group" data-simplebar>
        ...
        <div class="card-inner">
            <div class="user-account-info py-0">
                <h6 class="overline-title-alt">{{ __('Tenant Account')}}</h6>
        ...
        <div class="card-inner p-0">
            <ul class="link-list-menu">
                <li><a class="{{ active('tenant.profile') }}" href="{{ route('tenant.profile') }}">
                ...
                <li>
                    <a class="{{ active('tenant.login_activities') }}" href="{{ route('tenant.login_activities') }}">
                        <em class="icon ni ni-activity-round-fill"></em>
                        <span>{{ __('Account Activity')}}</span>
                    </a>
                </li>
                <li>
                    <a class="{{ active('tenant.security_settings') }}" href="{{ route('tenant.security_settings') }}">
