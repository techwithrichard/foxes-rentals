                    ...
                    <div class="kyc-app wide-sm m-auto">
                        <div class="nk-block-head nk-block-head-lg wide-xs mx-auto">
                            <div class="nk-block-head-content text-center">
                                ...
                                <div class="nk-block-des">
                                    <h6 class="title nk-block-title text-danger">
                                        Automatic payment initiation failed due to {{ $errorMessage }}. Try again later
                        ...
                        <div class="nk-block">
                            ...
                            <div class="text-center pt-4 pb-3"><p>If you have any question, please contact our support
                                    team
                                    <a href="mailto:info@softnio.com">0720 691 181</a></p></div>
                        </div>
                    </div>
