    ...
    <div class="container-fluid">
        <div class="nk-header-wrap">
            ...
            <div class="nk-header-brand d-xl-none">
                <a href="{{ route('tenant.home') }}" class="logo-link">
                    <img class="logo-light logo-img" src="{{ asset('assets/images/logo.png')}}" srcset="{{ asset('assets/images/logo2x.png')}} 2x"
                         alt="logo">
            ...
            <div class="nk-header-tools">
                <ul class="nk-quick-nav">
                        ...
                        <a href="#" class="dropdown-toggle" data-bs-toggle="dropdown">
                            <div class="user-toggle">
                                ...
                                <div class="user-info d-none d-md-block">
                                    <div class="user-status">{{ __('Tenant')}}</div>
                    ...
                    <li class="dropdown notification-dropdown me-n1">
                        <a href="#" class="dropdown-toggle nk-quick-nav-icon" data-bs-toggle="dropdown">
                            <!--If current user has unread notifications,show below icon-->
