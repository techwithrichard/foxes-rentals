...
{{ active(['admin.rent-invoice.*','admin.custom-invoice.*','admin.vouchers.*','admin.expenses.*']) }} ">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
                        ...
                        <ul class="nk-menu-sub">
                            @can('view invoice')
                                <li class="nk-menu-item {{ active('admin.rent-invoice.*') }}">
                                    <a href="{{ route('admin.rent-invoice.index') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">{{ __('Rent Invoices')}}</span></a>
                                </li>
                            @endcan

                            @can('view custom invoice')
                                <li class="nk-menu-item {{ active('admin.custom-invoice.*') }}">
                                    <a href="{{ route('admin.custom-invoice.index') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">{{ __('Custom Invoices')}}</span></a>
                                </li>
                            @endcan
                            ...
                            @can('view voucher')
                                ...
                                <li class="nk-menu-item {{ active('admin.vouchers.*') }}">
                                    <a href="{{ route('admin.vouchers.index') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">{{ __('Landlord Vouchers')}}</span></a>
                                </li>
                            @endcan

                            @can('view expense')
                                <li class="nk-menu-item {{ active('admin.expenses.*') }}">
                                    <a href="{{ route('admin.expenses.index') }}" class="nk-menu-link"><span
                                            class="nk-menu-text">{{ __('Expenses')}}</span></a>
                                </li>
                    ...
                    <li class="nk-menu-item has-sub
                     {{ active(['admin.payments.*','admin.deposits.*','admin.overpayments.*','admin.landlord-remittance.*','admin.mpesa-stk-transactions','admin.mpesa-c2b-transactions','admin.mpesa-c2b-transactions.reconcile']) }}">
                        <a href="#" class="nk-menu-link nk-menu-toggle">
...
{{--                            <li class="nk-menu-item has-sub {{ active(['admin.mpesa-stk-transactions','admin.mpesa-stk-transactions','admin.mpesa-c2b-transactions.reconcile']) }}">--}}
{{--                                <a href="#" class="nk-menu-link nk-menu-toggle">--}}
