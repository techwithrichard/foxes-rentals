                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ __('Custom Invoices')}}</h3>
                            ...
                            <div class="nk-block-head-content">
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        ...
                                        @can('create custom invoice')
                                            <ul class="nk-block-tools g-3">

                                                <li class="nk-block-tools-opt d-none d-sm-block">
                                                    <a href="{{ route('admin.custom-invoice.create') }}"
                                                       class="btn btn-primary"><em
                                                            class="icon ni ni-plus"></em><span>{{ __('Create Custom Invoice')}}</span></a>
                                                </li>
                            ...
                            <div class="card-inner">
                                ...
                                <table class="datatable table dt-responsive nowrap nk-tb-list nk-tb-ulist is-compact"
                                    ...
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th class="nk-tb-col">
                                            <span class="sub-text">{{ __('Due Date')}}</span>
                                        </th>
            ...
            let oTable = $("#tenants-list").DataTable(
                {
                    ...
                    "bLengthChange": false,
                    ajax: {
                        url: '{!! route('admin.custom-invoice.index') !!}',
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        {data: 'invoice_date', name: 'invoice_date', searchable: false, orderable: false},
