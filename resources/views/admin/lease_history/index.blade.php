                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ __('Leasing History')}}</h3>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li>
                                                <div>
                                                    <livewire:exports.past-leases-export-component/>
                    ...
                    <div class="nk-block">
                        <div class="card card-bordered card-preview">
                            <div class="card-inner">
                                ...
                                <table
                                    class="datatable datatable-wrap table dt-responsive nowrap nk-tb-list nk-tb-ulist is-compact"
                                    id="tenants-list">
                                    ...
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th data-priority="1" class="nk-tb-col">
                                            <span class="sub-text">{{ __('Lease ID')}}</span>
                                        </th>
                                        <th data-priority="1" class="nk-tb-col">
                                        ...
                                        <th data-priority="3" class="nk-tb-col">
                                            <span
                                                class="sub-text">{{ __('Terminated At')}}</span>
                                        </th>
            ...
            var oTable = $("#tenants-list").DataTable(
                {
                    ...
                    "bLengthChange": true,
                    ajax: {
                        url: '{!! route('admin.leases-history.index') !!}',
                        data: function (d) {
                    ...
                    columns: [
                        ...
                        {data: 'deleted_at', name: 'deleted_at', searchable: false, orderable: false},
