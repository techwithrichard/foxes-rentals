                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">{{ __('User Registration') }}</h5>
                                                <p>{{ __('Configure registration process and verification requirements') }}</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="nk-block">
                                        @if($registrationGroup && $registrationGroup->items->count() > 0)
                                            <div class="card">
                                                <div class="card-body">
                                                    <form id="registration-form">
                                                        <div class="row g-3">
                                                            @foreach($registrationGroup->items as $item)
                                                                <div class="col-lg-6">
                                        ...
                                        @else
                                            <div class="alert alert-info">
                                                {{ __('No registration settings found.') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
