                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">{{ __('Role Management') }}</h5>
                                                <p>{{ __('Configure user roles and their default permissions') }}</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="nk-block">
                                        @if($roleGroup && $roleGroup->items->count() > 0)
                                            <div class="card">
                                                <div class="card-body">
                                                    <form id="roles-form">
                                                        <div class="row g-3">
