                                    ...
                                    <div class="nk-block-head nk-block-head-lg">
                                        <div class="nk-block-between">
                                            <div class="nk-block-head-content">
                                                <h5 class="nk-block-title">{{ __('Permission Management') }}</h5>
                                                <p>{{ __('Configure system permissions and access controls') }}</p>
                                            </div>
                                        </div>
                                    </div>

                                    <div class="nk-block">
                                        @if($permissionGroup && $permissionGroup->items->count() > 0)
                                            <div class="card">
                                                <div class="card-body">
                                        ...
                                        @else
                                            <div class="alert alert-info">
                                                {{ __('No permission settings found.') }}
                                            </div>
                                        @endif
                                    </div>
                                </div>
