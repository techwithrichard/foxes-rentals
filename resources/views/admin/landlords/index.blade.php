                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ __('Landlords')}}</h3>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li>
                                                <div>
                                                    <livewire:exports.landlords-export-component/>
                                                ...
                                                <li class="nk-block-tools-opt">
                                                    <a href="{{ route('admin.landlords.create') }}"
                                                       class="btn btn-primary">
                                                        ...
                                                        <span>{{ __('Register Landlord')}}</span>
                                                    </a>
                                                </li>
                                            @endcan
                                        </ul>
                            ...
                            <div class="card-inner">
                                <table class="datatable table dt-responsive nowrap nk-tb-list nk-tb-ulist is-compact"
                                    ...
                                    <tr class="nk-tb-item nk-tb-head">
                                        ...
                                        <th class="nk-tb-col">
                                            <span
                                                class="sub-text">{{ __('Total Properties')}}</span>
                                        </th>
            ...
            var oTable = $("#tenants-list").DataTable(
                {
                    ...
                    "bInfo": true,
                    "bLengthChange": true,
                    ajax: '{!! route('admin.landlords.index') !!}',
                    autoWidth: false,
                    responsive: {
                        details: {
                    ...
                    columns: [
                        ...
                        {data: 'ownership', name: 'ownership', searchable: false, orderable: false},
