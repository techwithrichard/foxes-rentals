                    ...
                    <div class="nk-block-head nk-block-head-sm">
                        <div class="nk-block-between">
                            <div class="nk-block-head-content">
                                <h3 class="nk-block-title page-title">{{ __('Archived Tenants')}}</h3>
                                <div class="nk-block-des text-soft">
                                    <p>{{ __('List of tenants who have been deleted.They cannot log in or get assigned house')}}</p>
                                </div>
                                ...
                                <div class="toggle-wrap nk-block-tools-toggle">
                                    ...
                                    <div class="toggle-expand-content" data-content="pageMenu">
                                        <ul class="nk-block-tools g-3">
                                            <li>
                                                <div>
                                                    <livewire:exports.archived-tenants-export-component/>
            ...
            var oTable = $("#tenants-list").DataTable(
                {
                    ...
                    "bInfo": true,
                    "bLengthChange": true,
                    ajax: '{!! route('admin.archived-tenants.index') !!}',
                    autoWidth: false,
                    responsive: {
                        details: {
