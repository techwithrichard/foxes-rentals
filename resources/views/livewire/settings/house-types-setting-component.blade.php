    ...
    <div class="nk-block-head nk-block-head-lg">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">{{ __('House Types')}}</h5>
                <span>{{ __('Static room types to select during property creation.')}}</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $is_new ? 'Add':'Update'}} {{ __('House Type')}}</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label" for="full-name">{{ __('House Type')}}
                            <x-form.required/>
                        </label>
                    ...
                    <div class="d-flex justify-content-end mt-3 mb-3">
                        ...
                        <x-button loading="{{__('Saving ...')}}" wire:click="submit">
                            {{ $is_new ? __('Add House Type'):__('Update House Type')}}
                        </x-button>
                    </div>
