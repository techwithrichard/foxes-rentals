    ...
    <div class="nk-block-head nk-block-head-lg">
        <div class="nk-block-between">
            <div class="nk-block-head-content">
                <h5 class="nk-block-title">{{ __('Expense Types')}}</h5>
                <span>{{ __('Define expense categories to be used when creating an expense.')}}</span>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title">{{ $is_new ? 'Add':'Update'}} {{ __('Expense Category')}}</h5>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label class="form-label" for="full-name">{{ __('Expense Category')}}
                            <x-form.required/>
                        </label>
                    ...
                    <div class="d-flex justify-content-end mt-3 mb-3">
                        ...
                        <x-button loading="{{__('Saving ...')}}" wire:click="submit" class="btn btn-primary">
                            {{ $is_new ? __('Add Category'):__('Update Category')}}
                        </x-button>
                    </div>
