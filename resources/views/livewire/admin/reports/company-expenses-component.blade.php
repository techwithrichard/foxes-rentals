        ...
        <div class="card-inner-group">
            <div class="card-inner">
                ...
                <div class="row g-0 mb-2">
                    <div class="col-md-2">
                        <x-form.form-date wire:model="from_date" id="from-date" placeholder="{{ __('From Date')}}"/>
                    </div>
                    <div class="col-md-2">
                        <x-form.form-date wire:model="to_date" id="to-date" placeholder="{{ __('To Date')}}"/>
                    </div>
                    <div class="col-md-3 ms-auto float-end">
                        <x-button loading="{{__('Generating...')}}" wire:click="fetchExpenses" class="btn btn-primary">
                            {{__('Generate Report')}}
                        </x-button>
            ...
            <div class="card-inner">
                <div class="nk-block-head">
                    <div class="nk-block-head-content">
                        <h5 class="nk-block-title">{{ __('Company Expenses')}}</h5>
                        <div class="nk-block-des mb-4">
                            <p>{{ __('Company expenses report for expenses incurred between')}} <strong>{{$from_date}}</strong> {{ __('and')}}
