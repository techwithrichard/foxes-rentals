    ...
    <div class="card card-bordered">
        <div class="card-inner">
            <div class="card-head mb-3">
                <h5 class="card-title">{{ __('Add Voucher Details')}}</h5>
            </div>
            ...
            <div class="row gx-1 mb-2">
                ...
                <div class="col-sm-4">
                    ...
                    <div class="mb-1 row">
                        <label for="staticEmail" class="col-sm-4 col-form-label text-end">{{ __('Voucher Date')}}</label>
                        <div class="col-sm-8">
                            <x-form.form-date wire:model="voucher_date"/>
                        </div>
                    </div>
                    <div class="mb-0 row">
                        <label for="staticEmail" class="col-sm-4 col-form-label text-end">{{ __('Type')}}</label>
                        <div class="col-sm-8">
                            <div class="form-control-select">
                                <select class="form-control @error('voucher_type') is-invalid @enderror"
                                        wire:model="voucher_type">
                                    <option value="">{{ __('Select Voucher Type')}}</option>
                                    <option value="{{ \App\Enums\VoucherTypesEnum::RECEIPT }}">{{ __('Receipt')}}</option>
                                    <option value="{{ \App\Enums\VoucherTypesEnum::PAYMENT }}">{{ __('Payment')}}</option>
                                </select>
                            </div>
                        </div>
                    </div>
                    ...
                    <tr>
                        <th colspan="2">
                            <div class="form-group">
                                <div class="form-control-wrap">
                                    <textarea class="form-control" rows="1" wire:model.defer="notes"
            ...
            <div class="row mt-3">
                <div class="col-sm-12">
                    ...
                    <button type="button" class="btn btn-lg btn-primary float-end" wire:click="saveVoucher"
                            wire:loading.class="disabled"
                            id="{{ uniqid()}}"
                            data-redirect="no" wire:loading.attr="disabled">
                        <div wire:loading wire:target="saveVoucher">
