...
class ProperSampleSeeder extends Seeder
{
    /**
    ...
    public function run(): void
    {
        ...
        try {
            ...
            $landlord1->assignRole($landlordRole);
            ...
            $landlord2->assignRole($landlordRole);
            
            $this->command->info('Landlords created');
